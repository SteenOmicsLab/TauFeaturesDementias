...
#infile <- "PP_phopsho_INSOL.csv"
infile <- "PP_acetyl_INSOL.csv"
#infile <- "PP_phopsho_SOL.csv"
#infile <- "PP_acetyl_SOL.csv" 
...
outfile <- "PP_acetyl_INSOL_reformat.csv"
outfileC <- "PP_acetyl_INSOL_reformat_C.csv"
#outfile <- "PP_phopsho_SOL_reformat.csv"
#outfile <- "PP_acetyl_SOL_reformat.csv"
...
tmp$Neuropathology[startsWith(tmp$ID,"NPCAD")] <- "AD"
tmp$Neuropathology[startsWith(tmp$ID,"FTLDTau_Insol_01")] <- "AD"
tmp$Neuropathology[startsWith(tmp$ID,"FTLDTau_Insol_02")] <- "CBD"
tmp$Neuropathology[startsWith(tmp$ID,"FTLDTau_Insol_03")] <- "PSP"
tmp$Neuropathology[startsWith(tmp$ID,"CAA")] <- "AD"
