...
#pinfile_ptm <- "PP_phopsho_SOL_reformat.csv"

ainfile_ptm <- "PP_acetyl_INSOL_reformat.csv"
ainfile_c <- "PP_acetyl_INSOL_reformat_C.csv"
#ainfile_ptm <- "PP_acetyl_SOL_reformat.csv"

# Output: files merging different PTM search emphasis runs from ProteinPilot
outfile_ptm <- "PP_INSOL_reformat_combine2.csv"
outfile_c <- "PP_INSOL_reformat_combine_C2.csv"
#outfile_ptm <- "PP_SOL_reformat_combine.csv"
```
...
indata_ptm[startsWith(indata_ptm[,2],"NPCAD"),2] <- "AD"
indata_ptm[startsWith(indata_ptm[,2],"FTLDTau_Insol_01"),2] <- "AD"
indata_ptm[startsWith(indata_ptm[,2],"FTLDTau_Insol_02"),2] <- "CBD"
indata_ptm[startsWith(indata_ptm[,2],"FTLDTau_Insol_03"),2] <- "PSP"
indata_ptm[startsWith(indata_ptm[,2],"CAA"),2] <- "AD"
...
indata_c[startsWith(indata_c[,2],"NPCAD"),2] <- "AD"
indata_c[startsWith(indata_c[,2],"FTLDTau_Insol_01"),2] <- "AD"
indata_c[startsWith(indata_c[,2],"FTLDTau_Insol_02"),2] <- "CBD"
indata_c[startsWith(indata_c[,2],"FTLDTau_Insol_03"),2] <- "PSP"
indata_c[startsWith(indata_c[,2],"CAA"),2] <- "AD"
