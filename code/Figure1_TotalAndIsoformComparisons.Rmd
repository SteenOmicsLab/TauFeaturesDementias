...
axistitlesize <- 16
axistextsize <- 16
outfilename <- "C:/Users/Teaching/Desktop/BCH/Cell_September2025/Code-Data/outputfigure/Figure1_PanelsBCD_new8_2.pdf"

file_FLEXI.absolute <- "C:/Users/Teaching/Desktop/BCH/Cell_September2025/Code-Data/FLEXITau_isoform_absolutequant.csv"
file_FLEXI.tims.R <- "C:/Users/Teaching/Desktop/BCH/Cell_September2025/Code-Data/timsTOF_4Rstartincl_20240807_FLEXIpeptides.csv"
file_FLEXI <- "C:/Users/Teaching/Desktop/BCH/Cell_September2025/Code-Data/FLEXITau_Ratio_regionratio-collapse_normalized_filtered7.csv"
...
#data_FLEXI.iso.N <- filter(data_FLEXI.iso.N,"PiD",0.4,"LHratio","higher")
...
#data_FLEXI.iso.N <- data_FLEXI.iso.N[data_FLEXI.iso.N$Neuropathology!="CAA",]
...
#heights.N <- regheights.N
#ylabel.N <- "ratio [L/H]"
ylabel.N <- "absolute amount of\nisoform peptide [fmol/mg]"
heights.N <- logheights.N#logheights.N
#data_FLEXI.iso.N$value <- log10(data_FLEXI.iso.N$value)
#ylabel.N <- "log2 normalized ratio [L/H]"
...
plot_N_insoluble <- ggplot(data_FLEXI.iso.N,aes(x=Isoform,y=value)) + 
  ...
  ggtitle("2N, 1N, 0N\n(exon 2-3 splicing)") +
  scale_fill_manual(values=anno_colors$NPDX1) +
  #scale_y_continuous(sec.axis=dup_axis(label=NULL,name=""),labels=math_format(10^.x),name=ylabel.N) +
  ...
  #scale_y_continuous(sec.axis=dup_axis(label=NULL,name=""),name=ylabel.N,limits=c(NA,0)) +
...
plot_R_timsdata <- ggplot(timsdata.flexi,aes(x=Neuropathology,y=RisoformRatio)) + 
  ...
  scale_y_log10(sec.axis=dup_axis(label=NULL,name=""),limits=c(NA,80),breaks=trans_breaks("log10",function(x) 10^x),labels=trans_format("log10",math_format2(10^.x)),name=ylabel.R) + 
  annotation_logticks(side="l",short=unit(0.15,"cm"),mid=unit(0.15,"cm"),long=unit(0.25,"cm"),size=linesize) +
  annotation_logticks(side="r",short=unit(0.15,"cm"),mid=unit(0.15,"cm"),long=unit(0.25,"cm"),size=linesize) +
